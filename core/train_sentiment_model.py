...
def main():
    print("🧹 Analisis Dataset Sentiment...")
    ...
    model = AutoModelForSequenceClassification.from_pretrained(BASE_MODEL, num_labels=3, hidden_dropout_prob=0.3)

    # ========================================================
    # STRATEGI EXTREME FREEZE UNTUK DATASET < 500 BARIS
    # ========================================================
    for param in model.bert.parameters():
        param.requires_grad = False  # BEKUKAN 100% OTAK BERT
    ...
    args = TrainingArguments(
        output_dir="./tmp_sent", eval_strategy="epoch", save_strategy="epoch",
        load_best_model_at_end=True, metric_for_best_model="f1",
        per_device_train_batch_size=16, num_train_epochs=20,
        learning_rate=2e-3, # LR Ditingkatkan drastis karena layer bawah beku
    ...
    print("✅ Sentiment Model Bebas Overfitting Berhasil Disimpan!")
